...
function loadEmailList() {
  ...
  Object(_ajax_share__WEBPACK_IMPORTED_MODULE_0__["getMailList"])(userInfo.userId).then(maillist => {
...
const styles = ["silver-diagonal", "wax-diagonal", "violet-diagonal", "double-bubble", "carbon-fibre", "dark-paths", "diamond", "folk-pattern", "full-bloom", "leaves", "terrazzo", "pow-star", "repeated-square", "triangle-mosaic"];
